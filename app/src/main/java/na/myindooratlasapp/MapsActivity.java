...
public class MapsActivity extends FragmentActivity implements GoogleMap.OnMapClickListener, OnMapReadyCallback {
        ...
        if (mCircle == null) {
            ...
            if (mMap != null) {
                ...
                mCircle = mMap.addCircle(new CircleOptions()
                        ...
                        .strokeWidth(5.0f));
                //change marker when navigation starts to marker2 here wwe just add image
    ...
    private IARegion.Listener mRegionListener = new IARegion.Listener() {
        ...
        public void onEnterRegion(IARegion region) {
            ...
            speak("Please enter the destination");
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv2=(TextView)findViewById(R.id.distancetv);
       ...
       try {     sqlHelper = new SQLHelper(context);
    ...
    public void onMapClick(LatLng point) {
        ...
        if (mMap != null) {
            ...
            //set banner
            //get the value of room number
            String geo= sqlHelper.Rgeocode(point,mFloor);
            linearLayoutCompat.setVisibility(View.VISIBLE);
            textView.setText(geo);
            speak("Navigating to "+geo);
            mIALocationManager.requestWayfindingUpdates(mWayfindingDestination, mWayfindingListener);
    ...
    private boolean hasArrivedToDestination(IARoute route) {
        ...
        //update the textview
        String data=String.valueOf((int)routeLength)+"ft     Time:"+(int)routeLength/2+"sec";
        ///Toast.makeText(getApplicationContext(),"myroute"+String.valueOf(route.getLegs().get(1).getEnd().getLatitude()),Toast.LENGTH_SHORT).show();

        //can update the time approximation according to user's physical config
        tv2.setText(data);
        ...
        myTTS = new TextToSpeech(this, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int i) {
                if (myTTS.getEngines().size() == 0){
                    Toast.makeText(getApplicationContext(), "there is no TTS engine on your device", Toast.LENGTH_LONG).show();;
                    finish();
                }
                else{
                    myTTS.setLanguage(Locale.US);
                    speak("Welcome to Indoor Navigation. Please wait while map data is loading.");
                }
